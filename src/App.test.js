...
const tableOfContents = [
    { contentsUrl: "/pages/bar.html", id: "bar", title: "A Bar's Life" },
    { contentsUrl: "/pages/foo.html", id: "foo", title: "Foo" },
    { contentsUrl: "/pages/home.html", id: "home", title: "Our Doc Site" },
];
...
it("mapStateToProps returns expected props from store", () => {
    ...
    const { contents: actualFailContents } = mapStateToProps(
        { ...state, currentTitle: title, id: id + "-missing" },
        { tableOfContents }
    );
