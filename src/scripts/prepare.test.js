...
it("handles no data folder", async () => {
    ...
    expect(events).toEqual([
        ...
        {
            name: "writeFile",
            file: "public/output-pages/bar.html",
            data: "<h1>Some Other content</h1>",
        },
        {
            name: "writeFile",
            file: "public/output-pages/foo.html",
            data: "<h1>Some Other content!!</h1>",
        },
        {
            name: "writeFile",
            file: "non-existent/data.json",
            data: JSON.stringify(expectedParsedContents),
        },
    ]);
});
